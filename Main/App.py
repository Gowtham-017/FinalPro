...
if "logged_in_user" not in st.session_state:
    ...
    if selected == "Home":
        st.title("🍽️ Automatic Diet Recommendation")
        st.subheader("Your Personalized Nutrition Assistant")

        st.write("""
        Welcome to the **Automatic Diet Recommendation** system, an AI-driven health assistant designed to create 
        ...
        st.image("https://source.unsplash.com/800x400/?healthy-food", caption="Eat Healthy, Stay Fit!", use_column_width=True)
